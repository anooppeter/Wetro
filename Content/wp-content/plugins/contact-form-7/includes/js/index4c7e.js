!(function () {
            ...
            const { root: t, namespace: n = "contact-form-7/v1" } = wpcf7.api,
                a = s.reduceRight(
                    ...
                    (e) => {
                        let a,
                            o,
                            { url: i, path: s, endpoint: r, headers: c, body: l, data: p, ...d } = e;
                        "string" == typeof r &&
                            ((a = n.replace(/^\/|\/$/g, "")), (o = r.replace(/^\//, "")), (s = o ? a + "/" + o : a)),
                            "string" == typeof s &&
                            ...
                            delete c["X-WP-Nonce"],
                            p && ((l = JSON.stringify(p)), (c["Content-Type"] = "application/json"));
                        ...
                        return window.fetch(i || s || window.location.href, { ...d, headers: c, body: l }).then(
                            (e) =>
                                Promise.resolve(e)
                                    .then((e) => {
    ...
    const c = function (e) {
        ...
        f = function (e) {
            if (
                !e
                    .getAll(this.field)
                    .every((e) => ((e = (e = e.trim()).replaceAll(/[()/.*#\s-]+/g, "")), /^[+]?[0-9]+$/.test(e)))
            )
                throw new r(this);
        },
        u = function (e) {
                                            ...
                                            if (n) {
                                                ...
                                                for (const [o, i] of (() => {
                                                    ...
                                                    return (
                                                        ...
                                                        e.set("pot|pps|ppt", "application/vnd.ms-powerpoint"),
                                                        e.set("wri", "application/vnd.ms-write"),
                                                        e.set("xla|xls|xlt|xlw", "application/vnd.ms-excel"),
                                                        ...
                                                        e.set("docm", "application/vnd.ms-word.document.macroEnabled.12"),
                                                        e.set(
                                                            "dotx",
                                                            "application/vnd.openxmlformats-officedocument.wordprocessingml.template"
                                                        ),
                                                        e.set("dotm", "application/vnd.ms-word.template.macroEnabled.12"),
                                                        e.set(
                                                            "xlsx",
                                                            "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
                                                        ),
                                                        e.set("xlsm", "application/vnd.ms-excel.sheet.macroEnabled.12"),
                                                        e.set(
                                                            "xlsb",
                                                        ...
                                                        e.set("xltm", "application/vnd.ms-excel.template.macroEnabled.12"),
                                                        e.set("xlam", "application/vnd.ms-excel.addin.macroEnabled.12"),
                                                        e.set(
                                                            "pptx",
                                                        ...
                                                        e.set("onetoc|onetoc2|onetmp|onepkg", "application/onenote"),
                                                        e.set("oxps", "application/oxps"),
                                                        e.set("xps", "application/vnd.ms-xpsdocument"),
                                                        e.set("odt", "application/vnd.oasis.opendocument.text"),
                                                        e.set("odp", "application/vnd.oasis.opendocument.presentation"),
                                                        e.set("ods", "application/vnd.oasis.opendocument.spreadsheet"),
                                                        e.set("odg", "application/vnd.oasis.opendocument.graphics"),
                                                        e.set("odc", "application/vnd.oasis.opendocument.chart"),
                                                        e.set("odb", "application/vnd.oasis.opendocument.database"),
                                                        e.set("odf", "application/vnd.oasis.opendocument.formula"),
                                                    ...
                                                    (("*" === a && i.startsWith(e + "/")) || i === n[0]) &&
                                                        t.push(...o.split("|"));
                                            }
                                            return t;
                                        })(t).some(
                                            (t) => ((t = "." + t.trim()), e.name.toLowerCase().endsWith(t.toLowerCase()))
                                        )
                              ))
                    );
                })
        ...
        const t = () => {
            ...
            return (
                ...
                (e.set = function (t, n) {
                    "" === t
                        ? (t = e.largestIndex++)
                        : /^[0-9]+$/.test(t) && ((t = parseInt(t)), e.largestIndex <= t && (e.largestIndex = t + 1)),
        ...
        for (const [e, a] of this.formData) {
            ...
            if (o)
                if ("" === o.groups.array) this.tree.set(o.groups.name, a);
                    ...
                    const e = [...o.groups.array.matchAll(/\[([a-z][-a-z0-9_:]*|[0-9]*)\]/gi)].map(([e, t]) => t);
    ...
    function S(e) {
        ...
        for (const e of c.querySelectorAll(".wpcf7-form-control-wrap"))
            if (
                ...
                break;
        const d = null !== (o = S.validators) && void 0 !== o ? o : {},
            f = (null !== (i = e.wpcf7.schema.rules) && void 0 !== i ? i : []).filter((e) => {
                let { rule: t, ...n } = e;
                return (
                    "function" == typeof d[t] &&
                    ("function" == typeof d[t].matches ? d[t].matches(n, s) : p.includes(n.field))
                );
            });
        if (!f.length) return;
            ...
            .then((t) => {
                ...
                for (const { rule: t, ...o } of f)
                    if (!n.includes(o.field))
                        try {
                            $(e, o.field), d[t].call({ rule: t, ...o }, a);
                        } catch (t) {
                            t instanceof r && (_(e, o.field, t.error), n.push(o.field));
                        }
            })
            .finally(() => {
                a(e, u),
    ...
    const _ = (e, t, n) => {
            var a;
            const o = `${null === (a = e.wpcf7) || void 0 === a ? void 0 : a.unitTag}-ve-${t}`.replaceAll(
                    /[^0-9a-z_-]+/gi,
                    ""
                ),
                    ...
                    a.classList.add("wpcf7-not-valid-tip"),
                        ...
                        t.querySelectorAll(".wpcf7-form-control").forEach((e) => {
                            e.classList.add("wpcf7-not-valid"),
                                ...
                                "function" == typeof e.setCustomValidity && e.setCustomValidity(n),
        ...
        $ = (e, t) => {
            var n, a;
            const o = `${null === (n = e.wpcf7) || void 0 === n ? void 0 : n.unitTag}-ve-${t}`.replaceAll(
                /[^0-9a-z_-]+/gi,
                ""
            );
            null === (a = e.wpcf7.parent.querySelector(`.screen-reader-response ul li#${o}`)) || void 0 === a || a.remove(),
    ...
    function L(e) {
        ...
        if (wpcf7.blocked) return k(e), void a(e, "submitting");
    ...
    i.use((e, t) => {
        if (e.wpcf7 && "feedback" === e.wpcf7.endpoint) {
            ...
            k(t), o(t, "beforesubmit", n), a(t, "submitting");
        }
        return t(e);
    });
    const k = (e) => {
        e.querySelectorAll(".wpcf7-form-control-wrap").forEach((t) => {
            t.dataset.name && $(e, t.dataset.name);
        }),
    ...
    const j = (e, t) => {
            for (const n in t) {
                ...
                o &&
                    e.querySelectorAll(`input[name="_wpcf7_captcha_challenge_${n}"]`).forEach((e) => {
                        e.value = o[1];
                    });
            }
        },
            ...
            for (const n in t) {
                ...
                e.querySelectorAll(`.wpcf7-form-control-wrap[data-name="${n}"]`).forEach((e) => {
                    (e.querySelector(`input[name="${n}"]`).value = ""),
                        ...
                        (e.querySelector(`input[name="_wpcf7_quiz_answer_${n}"]`).value = o);
                });
            }
        };
    function O(e) {
        ...
        (e.wpcf7 = {
            ...
            ((e) => {
                const t = (e, t) => {
                        ...
                        e.setAttribute("data-current-value", s),
                            ...
                            i && t.value.length < i ? e.classList.add("too-short") : e.classList.remove("too-short");
                    },
                    a = (n) => {
                        (n = { init: !1, ...n }),
            ...
            e.addEventListener("wpcf7submit", (t) => {
                t.detail.apiResponse.captcha && j(e, t.detail.apiResponse.captcha),
                    t.detail.apiResponse.quiz && T(e, t.detail.apiResponse.quiz);
            }),
    ...
    document.addEventListener("DOMContentLoaded", (e) => {
        ...
        if ("function" != typeof window.FormData)
            return void console.error("Your browser does not support window.FormData().");
        const n = document.querySelectorAll(".wpcf7 > form");
        "function" == typeof n.forEach
            ? ((wpcf7 = { init: O, submit: L, reset: z, validate: S, ...(null !== (t = wpcf7) && void 0 !== t ? t : {}) }),
